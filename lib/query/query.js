...
var EventEmitter = require('events').EventEmitter,
    ...
    isEmtpyStr = require('../utils').isEmptyStr,
...
Query.prototype.validate = function (){
        ...
        for(let field of this.requiredField){
            if(queryFields.indexOf(field) == -1)
                ...
                if(isEmtpyStr(this._query[field]) ||
                   (Array.isArray(this._query[field]) && isEmptyArray(this._query[field]) ||
                    ...
                    if(Array.isArray(this._query[field]) && typeof this._query[field][0] == 'object')
                        each(this._query[field].validate())
                    else if(typeof this._query[field] == 'object')
